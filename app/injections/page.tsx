        ...
        <div>
          ...
          <div style={styles.card}>
            ...
            <ul style={{ paddingRight: '20px' }}>
              ...
              <li style={styles.listItem}><strong>العلاجات الحيوية (PRP، الخلايا الجذعية):</strong> فلسفة تجددية تستخدم مكونات دم أو أنسجة المريض نفسه لتعزيز الشفاء وإصلاح الأنسجة في الإصابات المزمنة أو التدهور في مراحل مبكرة.</li>
            </ul>
          </div>
